    ...
    angular.module('createDialog', []).factory('createDialog', ["$document", "$compile", "$rootScope", "$controller", "$timeout",
        function ($document, $compile, $rootScope, $controller, $timeout) {
            ...
            return function Dialog(templateUrl/*optional*/, options, passedInLocals) {
                ...
                var defaultFooter = '<button class="primary" ng-click="$modalSuccess()">{{$modalSuccessLabel}}</button>' +
                    '<button class="" ng-click="$modalCancel()">{{$modalCancelLabel}}</button>';
                ...
                var modalEl = angular.element(
                    '<div class="' + options.modalClass + ' fade stats"' + idAttr + ' style="display: block;">' +
                ...
                //if user click on browser backward or forward when dialog opens
