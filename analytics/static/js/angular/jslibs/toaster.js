define(['angular', 'angular_animation'], function (angular) {
...
angular.module('toaster', ['ngAnimate'])
    .service('toaster', ['$rootScope', function ($rootScope) {
        this.pop = function (type, title, body, timeout, bodyOutputType,positionclass) {
            ...
            $rootScope.$broadcast('toaster-pebooToast');
        };
        this.init = function(type, title, body, timeout, bodyOutputType,positionclass) {
            this.toast = {
                type: type,
                title: title,
                body: body,
        ...
        function ($compile, $timeout, $sce, toasterConfig, toaster) {
            return {
                ...
                link: function (scope, elm, attrs) {
                    ...
                    scope.$on('toaster-pebooToast', function () {
                        addToast(toaster.toast);
                    });
